...
<div id="role-error-alert" class="fixed top-4 right-4 z-50 max-w-md bg-pink-600 text-white p-4 rounded-lg shadow-lg">
    <div class="flex items-center gap-3">
        ...
        <div>
            <p class="font-semibold"><?php echo e(session('role_error')); ?></p>
        </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <div class="flex-shrink-0 flex items-center gap-4 border-t md:border-t-0 md:border-l border-gray-700 pt-4 md:pt-0 md:pl-6 w-full md:w-auto">
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-sm text-gray-400 leading-tight"><?php echo e($user->email ?? 'N/A'); ?></p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-1 themed-card p-6 space-y-6 animate-on-scroll" style="animation-delay: 100ms;">
                ...
                <div class="space-y-4 text-sm pl-9">
                    <div>
                        ...
                        <p class="font-semibold text-lg text-white"><?php echo e($totalKelompok); ?> Kelompok</p>
                    </div>
                    <div>
                        <p class="text-gray-400">Total Mahasiswa Dibimbing</p>
                        <p class="font-semibold text-teal-400"><?php echo e($totalMahasiswa); ?> Mahasiswa</p>
                    </div>
                    <div>
                        <h4 class="font-semibold text-gray-300 mt-4 mb-1">Cluster yang Dibimbing</h4>
                        <?php if($kelompokDibimbing->count() > 0): ?>
                        <a href="<?php echo e(route('spv.cluster.index')); ?>" class="text-amber-400 hover:text-amber-300 transition-colors">
                            Lihat <span class="font-bold"><?php echo e($kelompokDibimbing->count()); ?></span> kelompok »
                        </a>
                        <?php else: ?>
            ...
            <div class="lg:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div class="themed-card p-6 flex flex-col gap-2 animate-on-scroll" style="animation-delay: 200ms;">
                    ...
                    <p class="text-5xl font-display font-bold text-white"><?php echo e($tugasSelesai); ?></p>
                ...
                <a href="<?php echo e(route('spv.tugas.index')); ?>" class="bg-teal-600 p-6 rounded-xl flex flex-col items-center justify-center text-center text-white hover:bg-teal-500 transition-colors group animate-on-scroll" style="animation-delay: 400ms;">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
            <div class="lg:col-span-2 themed-card p-6 animate-on-scroll">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        <a href="<?php echo e(route('spv.pengumuman.detail', $announce->id)); ?>" class="font-semibold text-base text-white hover:text-amber-400 transition-colors"><?php echo e($announce->judul); ?></a>
                        ...
                        <tbody class="divide-y divide-gray-800">
                            ...
                            <tr class="hover:bg-gray-800/60 transition-colors duration-200">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold">
                                    <a href="<?php echo e(route('spv.jadwal.detail', $item->id)); ?>" class="text-white hover:text-teal-300 transition-colors"><?php echo e($item->nama_acara); ?></a>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                                    <?php echo e($item->tanggal_mulai->format('d M Y, H:i')); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                                    <?php echo e($item->lokasi ?? 'Online'); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <a href="<?php echo e(route('spv.jadwal.detail', $item->id)); ?>" class="inline-block px-4 py-2 text-xs font-bold font-display rounded-md transition-all duration-300 transform hover:scale-105 bg-teal-500 text-black hover:bg-teal-400">
                                        LIHAT
                                    </a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\yuwaraja-new\resources\views/spv/dashboard.blade.php ENDPATH**/ ?>