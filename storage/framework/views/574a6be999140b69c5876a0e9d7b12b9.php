...
<head>
    ...
    <title>Halaman Tidak Ditemukan - <?php echo e(config('app.name', 'YUWARAJA XVII')); ?></title>
    ...
    <div class="relative z-10 text-center px-6 max-w-2xl mx-auto">
        ...
        <div class="mt-12 text-center">
            <p class="text-gray-400 text-sm font-kanit">
                ...
                <a href="<?php echo e(url('/login')); ?>" class="text-cyan-400 hover:text-cyan-300 underline">
                    login ke akun Anda
                </a>
            </p>
        </div>
        ...
        <div class="mt-8 flex justify-center">
            <img src="<?php echo e(asset('images/logo-yuwarajaxvii.svg')); ?>" 
                 alt="YUWARAJA XVII" 
...
</html><?php /**PATH C:\laragon\www\yuwaraja-new\resources\views/errors/404.blade.php ENDPATH**/ ?>