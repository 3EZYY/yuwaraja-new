...
<div class="font-body bg-gray-900 min-h-screen py-12 sm:py-16" style="background-image: radial-gradient(circle at top, #1a202c, #0a0f14);">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div class="flex items-center gap-6">
                    ...
                    <div class="relative group">
                        <?php if(isset($kelompokDibimbing) && $kelompokDibimbing->count() > 0 && $kelompokDibimbing->first()->photo): ?>
                            <?php
                                $photoPath = $kelompokDibimbing->first()->photo;
                                $fullPhotoUrl = asset('storage/' . $photoPath);
                            ?>
                            <img src="<?php echo e($fullPhotoUrl); ?>" 
                                 alt="Cluster Profile" 
                                 title="Foto Cluster"
  ...
  <path d="M5.082 14.254a8.287 8.287 0 0 0-1.308 5.135 9.687 9.687 0 0 1-1.764-.44l-.115-.04a.563.563 0 0 1-.373-.487l-.01-.121a3.75 3.75 0 0 1 3.57-4.047ZM20.226 19.389a8.287 8.287 0 0 0-1.308-5.135 3.75 3.75 0 0 1 3.57 4.047l-.01.121a.563.563 0 0 1-.373.486l-.115.04c-.567.2-1.156.349-1.764.441Z" />
                        ...
                        <?php if(isset($kelompokDibimbing) && $kelompokDibimbing->count() > 0): ?>
                            <p class="text-gray-400 mt-1">Kelompok: <span class="text-teal-300 font-semibold"><?php echo e($kelompokDibimbing->first()->nama_kelompok); ?></span></p>
                            <p class="text-teal-300 text-sm mt-1 font-medium">Kode: <?php echo e($kelompokDibimbing->first()->code); ?></p>
                        <?php else: ?>
                ...
                <a href="<?php echo e(route('spv.dashboard')); ?>" class="inline-flex items-center gap-2 text-sm text-teal-300 hover:text-amber-400 transition-colors group lg:self-start">
        ...
        <!-- Alert Messages -->
        <?php if(session('success')): ?> <div class="bg-green-500/10 border border-green-500/30 text-green-300 text-sm p-3 rounded-lg mb-6 flex items-center gap-3"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg><span><?php echo e(session('success')); ?></span></div> <?php endif; ?>
        <?php if(session('error')): ?> <div class="bg-red-500/10 border border-red-500/30 text-red-300 text-sm p-3 rounded-lg mb-6 flex items-center gap-3"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg><span><?php echo e(session('error')); ?></span></div> <?php endif; ?>
        ...
        <div class="space-y-8">
                ...
                <div class="flex items-center space-x-4">
                    <div class="relative group">
                        <?php if(auth()->user()->photo): ?>
                            <img src="<?php echo e(asset('profile-pictures/' . auth()->user()->photo)); ?>" alt="<?php echo e(auth()->user()->name); ?>" class="w-16 h-16 rounded-full border-2 border-cyan-400 flex-shrink-0">
                            <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity rounded-full flex items-center justify-center">
                    ...
                    <div class="flex-1">
                        <h3 class="text-lg font-bold text-white"><?php echo e(auth()->user()->name); ?></h3>
            ...
            <div>
                ...
                <?php if(isset($kelompokDibimbing) && $kelompokDibimbing->count() > 0): ?>
                    <div class="space-y-6">
                        <?php $__currentLoopData = $kelompokDibimbing; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelompok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z" />
                                    ...
                                    <!-- Info Cluster -->
                                    <div>
                                        <h3 class="text-xl font-bold text-white mb-1 group-hover:text-white transition-colors duration-300"><?php echo e($kelompok->nama_kelompok); ?></h3>
                                        <div class="flex items-center gap-3">
                                            <p class="text-gray-400 text-sm"><?php echo e($kelompok->mahasiswa->count()); ?> Anggota</p>
                            ...
                            <div>
                                ...
                                <?php if($kelompok->mahasiswa->count() > 0): ?>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                                        <?php $__currentLoopData = $kelompok->mahasiswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mahasiswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="flex flex-col items-center text-center">
                                                <?php if($mahasiswa->photo): ?>
                                                    <div class="relative mb-3">
                                                        <img src="<?php echo e(asset('profile-pictures/' . $mahasiswa->photo)); ?>" alt="<?php echo e($mahasiswa->name); ?>" class="w-16 h-16 rounded-full border-2 border-cyan-400/50 group-hover/member:border-cyan-400 transition-colors duration-300 object-cover">
                                                ...
                                                <?php else: ?>
                                                    <div class="relative mb-3">
                                                        <div class="w-16 h-16 rounded-full bg-gradient-to-br from-cyan-400/20 to-cyan-600/20 flex items-center justify-center text-cyan-300 font-bold text-xl font-display border-2 border-cyan-400/50 group-hover/member:border-cyan-400 transition-colors duration-300">
                                                            <?php echo e(strtoupper(substr($mahasiswa->name, 0, 1))); ?>
                                                ...
                                                <!-- Info Mahasiswa -->
                                                <div class="w-full">
                                                    <h3 class="text-base font-bold text-white mb-1 truncate group-hover/member:text-cyan-300 transition-colors duration-300"><?php echo e($mahasiswa->name); ?></h3>
                                                    <p class="text-gray-400 text-xs mb-3 font-mono"><?php echo e($mahasiswa->nim ?? 'NIM belum diisi'); ?></p>
                                        ...
                                        <?php if($mahasiswa->id !== auth()->user()->id): ?>
                                        <button onclick="confirmKickMember(<?php echo e($mahasiswa->id); ?>, '<?php echo e($mahasiswa->name); ?>')" class="inline-flex items-center justify-center gap-1.5 w-full px-3 py-2 rounded-lg text-xs font-semibold bg-red-500/15 hover:bg-red-500/25 text-red-400 hover:text-red-300 border border-red-500/25 hover:border-red-400/40 transition-all duration-300 group/kick">
                ...
                <?php else: ?>
                    <div class="space-y-6">
                        ...
                        <div class="bg-gradient-to-br from-gray-900/80 to-gray-800/60 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/30">
                            ...
                            <form method="POST" action="<?php echo e(route('spv.cluster.join')); ?>" class="max-w-md mx-auto" onsubmit="return validateJoinForm(event)">
                                <?php echo csrf_field(); ?>
                                <div class="space-y-4">
                                    <div>
...
function uploadClusterProfilePhoto() {
    <?php if(isset($kelompokDibimbing) && $kelompokDibimbing->count() > 0): ?>
        const kelompokId = <?php echo e($kelompokDibimbing->first()->id); ?>;
        ...
        input.onchange = function(e) {
            ...
            fetch('<?php echo e(route("spv.cluster.upload-photo")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
...
function uploadProfilePhoto() {
    ...
    input.onchange = function(e) {
        ...
        fetch('<?php echo e(route("spv.profile.upload-photo")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
function executeKickMember(userId) {
    ...
    // Send AJAX request
    fetch('<?php echo e(route("spv.cluster.kick-member")); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.spv', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\yuwaraja-new\resources\views/spv/cluster.blade.php ENDPATH**/ ?>