...
<div class="font-body bg-gray-900 min-h-screen flex items-center justify-center px-4 py-12 sm:py-16" style="background-image: radial-gradient(circle at top, #1a202c, #0a0f14);">
    <main class="w-full max-w-lg">
        ...
        <div class="bg-gray-950/70 backdrop-blur-xl shadow-2xl rounded-2xl border border-teal-500/20 p-6 sm:p-8 md:p-10">
            ...
            <?php if(session('info')): ?> <div class="bg-blue-500/10 border border-blue-500/30 text-blue-300 text-sm p-3 rounded-lg mb-6 flex items-center gap-3"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg><span><?php echo e(session('info')); ?></span></div> <?php endif; ?>

            
            <form method="POST" action="<?php echo e(route('mahasiswa.join-kelompok.submit')); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
                <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\yuwaraja-new\resources\views/mahasiswa/join-kelompok.blade.php ENDPATH**/ ?>