...
<head>
    ...
    <title>Session Expired - <?php echo e(config('app.name', 'YUWARAJA XVII')); ?></title>
    ...
    <div class="relative z-10 text-center px-6 max-w-2xl mx-auto">
        ...
        <div class="mt-12 text-center">
            <p class="text-gray-400 text-sm font-kanit">
                ...
                <br>
                <a href="<?php echo e(url('/')); ?>" class="text-red-400 hover:text-red-300 underline">
                    Kembali ke beranda
                </a>
            </p>
        </div>
...
</html><?php /**PATH C:\laragon\www\yuwaraja-new\resources\views/errors/419.blade.php ENDPATH**/ ?>