            ...
            <div class="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-6">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div class="mb-4 lg:mb-0">
                        <!-- Back Navigation -->
                        <a href="<?php echo e(route('spv.absensi.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-700 hover:bg-gray-600 border border-gray-600 rounded-lg text-gray-300 hover:text-white transition-all duration-300 mb-4">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <div class="bg-gradient-to-r from-amber-500 to-orange-500 rounded-lg p-4 text-center shadow-lg">
                            <div class="text-lg font-bold text-white"><?php echo e($absensi->tanggal->format('d M Y')); ?></div>
                        ...
                        <div class="bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg p-4 text-center shadow-lg">
                            <div class="text-lg font-bold text-white"><?php echo e($absensi->jam_mulai_formatted); ?>-<?php echo e($absensi->jam_selesai_formatted); ?></div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                                ...
                                <div class="bg-gray-700 rounded-lg p-4 border border-gray-600">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-white font-medium"><?php echo e($absensi->judul); ?></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="bg-gray-700 rounded-lg p-4 border border-gray-600">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-white font-medium"><?php echo e($absensi->tanggal->format('d M Y')); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-gray-700 rounded-lg p-4 border border-gray-600">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-white font-medium"><?php echo e($absensi->jam_mulai_formatted); ?>-<?php echo e($absensi->jam_selesai_formatted); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-gray-700 rounded-lg p-4 border border-gray-600">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium mt-1 <?php echo e($absensi->status === 'aktif' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                        ...
                        <div>
                            ...
                            <div class="bg-gray-700 rounded-lg p-4 border border-gray-600">
                                <p class="text-gray-300 leading-relaxed"><?php echo e($absensi->deskripsi); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div class="bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg p-4 text-center shadow-lg">
                                <div class="text-2xl font-bold text-white"><?php echo e($totalRequests); ?></div>
            ...
            <div class="p-6">
                ...
                <div class="mb-6">
                    <nav class="flex flex-wrap gap-2" aria-label="Tabs">
                        <a href="?status=all" class="<?php echo e(request('status', 'all') === 'all' ? 'bg-blue-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'); ?> px-4 py-2 rounded-lg font-medium text-sm transition-colors duration-200">
                            Semua (<?php echo e($totalRequests); ?>)
                        </a>
                        <a href="?status=pending" class="<?php echo e(request('status') === 'pending' ? 'bg-yellow-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'); ?> px-4 py-2 rounded-lg font-medium text-sm transition-colors duration-200">
                            Menunggu (<?php echo e($pendingCount); ?>)
                        </a>
                        <a href="?status=approved" class="<?php echo e(request('status') === 'approved' ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'); ?> px-4 py-2 rounded-lg font-medium text-sm transition-colors duration-200">
                            Disetujui (<?php echo e($approvedCount); ?>)
                        </a>
                        <a href="?status=rejected" class="<?php echo e(request('status') === 'rejected' ? 'bg-red-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'); ?> px-4 py-2 rounded-lg font-medium text-sm transition-colors duration-200">
                            Ditolak (<?php echo e($rejectedCount); ?>)
                        </a>
                    </nav>
                </div>
                        ...
                        <tbody class="bg-gray-800 divide-y divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-700 transition-colors duration-200">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            ...
                                            <img class="h-10 w-10 rounded-full object-cover" src="<?php echo e(asset('profile-pictures/' . $request->mahasiswa->photo)); ?>" alt="">
                                            <?php else: ?>
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="text-sm text-gray-400"><?php echo e($request->mahasiswa->nim); ?></div>
                                            <div class="text-xs text-gray-500"><?php echo e($request->mahasiswa->kelompok->nama_kelompok ?? 'Tidak Ada Kelompok'); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-300"><?php echo e($request->created_at->format('d M Y')); ?></div>
                                    <div class="text-xs text-gray-400"><?php echo e($request->created_at->format('H:i')); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-400 max-w-xs">
                                    <div class="truncate"><?php echo e($request->keterangan ?? 'Tidak ada catatan'); ?></div>
                                    <?php if($request->approved_at): ?>
                                    <div class="text-xs text-gray-500 mt-1">
                                        Diproses: <?php echo e($request->approved_at->format('d M Y H:i')); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    ...
                                    <div class="flex space-x-2">
                                        <form action="<?php echo e(route('spv.absensi.approve', $request)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <button onclick="openRejectModal(<?php echo e($request->id); ?>)" class="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded text-xs font-medium transition-colors duration-200">
                                            Tolak
                                        </button>
                                    </div>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.spv', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\yuwaraja-new\resources\views/spv/absensi/show.blade.php ENDPATH**/ ?>