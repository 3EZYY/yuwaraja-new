        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-purple-600 overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-6 text-white">
                    ...
                    <p class="text-blue-100">Jurusan: {{ $user->program_studi ?? 'Belum diisi' }}</p>
                </div>
            </div>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                            <a href="{{ route('mahasiswa.tugas.show', $task) }}" class="text-blue-600 hover:text-blue-800 hover:underline">
                                                {{ $task->judul }}
                                            </a>
                                        </td>
