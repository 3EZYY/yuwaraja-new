...
<head>
    ...
    <title>{{ $tugas->judul }} - PPKMB XVII</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <h1 class="text-xl font-bold text-white">PPKMB XVII</h1>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="{{ route('dashboard') }}" class="text-white hover:text-blue-200 transition">
                ...
                @else
                    ...
                    @if(now() <= $tugas->deadline)
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                            ...
                            <form action="{{ route('tugas.submit', $tugas) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                                @csrf
