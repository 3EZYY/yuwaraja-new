    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <header class="flex flex-col sm:flex-row items-center gap-6 mb-12">
            <div class="relative flex-shrink-0 group">
                <div class="absolute -inset-1.5 bg-gradient-to-r from-teal-400 to-amber-400 rounded-full blur opacity-50 group-hover:opacity-75 transition duration-500 animate-pulse"></div>
                @if(Auth::user()->photo)
                ...
                <div class="relative h-24 w-24 sm:h-28 sm:w-28 rounded-full bg-gray-800 flex items-center justify-center border-2 border-gray-700">
                    <span class="font-display text-4xl font-bold text-black">{{ strtoupper(substr(Auth::user()->name, 0, 1)) }}</span>
                </div>
                @endif
            </div>
            <div>
        ...
        <div class="lg:col-span-2 space-y-8 mb-10">
            ...
            <section class="bg-gray-900/50 backdrop-blur-xl p-6 sm:p-8 rounded-2xl border border-teal-500/20">
                <header class="mb-6">
                    ...
                    <p class="text-gray-400 text-sm mt-1">Perbarui data diri dan alamat email Anda di sini.</p>
                </header>
            ...
            <section class="bg-gray-900/50 backdrop-blur-xl p-6 sm:p-8 rounded-2xl border border-teal-500/20">
                <header class="mb-6">
                    ...
                    <p class="text-gray-400 text-sm mt-1">Untuk menjaga keamanan, gunakan kata sandi yang kuat dan unik.</p>
                </header>
        ...
        <div class="lg:col-span-1">
            <section class="bg-red-900/10 backdrop-blur-xl p-6 sm:p-8 rounded-2xl border border-red-500/20">
                <header class="mb-6">
                    ...
                    <p class="text-red-300/80 text-sm mt-1">Harap berhati-hati. Tindakan di bawah ini bersifat permanen.</p>
                </header>
